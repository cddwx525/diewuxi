...
class list_category extends guest_base
{
    public function get_items($result)
    {
        ...
        $position = " > <a href=\"" . $url->get(array($result["meta_data"]["settings"]["app_space_name"], "guest/article.list_category", ""), array("category_id" => $category["id"]), "") . "\">Category: " . htmlspecialchars($category["name"]) . "</a>";
