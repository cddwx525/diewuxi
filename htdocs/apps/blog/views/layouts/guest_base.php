...
use swdf\base\view;
use blog\widgets\category_side;
use blog\widgets\tag_cloud;

abstract class guest_base extends view
{
    ...
    private function get_main()
    {
        $main = html::tag(
            ...
            html::tag(
                ...
                html::tag(
                    "div",
                    category_side::widget(array("data" => \swdf::$app->data["category_tree"])),
                    array()
                ) .  "\n" .
                html::inline_tag(
                    "h3",
