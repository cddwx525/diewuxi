...
abstract class admin_base extends view
{
    ...
    public function get_menu()
    {
        $menu_data = array(
            ...
            array(
                url::get(array(\swdf::$app->name, "admin/article.list_all", ""), array(), ""),
                "Articles",
            ),
            array(
                url::get(array(\swdf::$app->name, "admin/category.list_all", ""), array(), ""),
                "Cateories",
            ),
            array(
                url::get(array(\swdf::$app->name, "admin/tag.list_all", ""), array(), ""),
                "Tags",
            ),
            array(
                url::get(array(\swdf::$app->name, "admin/comment.list_all", ""), array(), ""),
                "Comments",
            ),
            array(
        ...
        $menu = html::tag(
            ...
            html::tag(
                ...
                html::inline_tag(
                    "li",
                    html::a("Logout", url::get(array(\swdf::$app->name, "admin/authentication.logout", ""), array(), ""), array()),
                    array("class" => "inline text-padding")
                ),
                array("class" => "unstyle-list inline-block")
            ),
