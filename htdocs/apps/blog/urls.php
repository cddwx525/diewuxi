...
class urls
{
    public function url_map()
    {
        ...
        $url_map = array(
            ...
            array(
                "^/articles\?tag_id=(?P<tag_id>\d+)$",
                array("/articles?tag_id=",),
                array("tag_id",),
                array($app_name, "COMMON", "guest/article", "list_tag", "", ""),
                array($app_name, "guest/article.list_tag", "",),
            ),
            array(
                "^/article/(?P<id>\d+)$",
                array("/article/",),
            ...
            /*
            array(
                "^/articles/(?P<full_category>(\w+)(/\w+)*)/(?P<slug>\w+)\.html$",
                array("/articles/", "/", ".html"),
                array("full_category", "slug", ""),
                array($app_name, "COMMON", "article_single", "", ""),
                array($app_name, "article_single", "",),
            ),
             */
